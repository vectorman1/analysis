...
type Trading212ServiceClient interface {
	GetUpdatedSymbols(ctx context.Context, in *Symbols, opts ...grpc.CallOption) (Trading212Service_GetUpdatedSymbolsClient, error)
...
func (c *trading212ServiceClient) GetUpdatedSymbols(ctx context.Context, in *Symbols, opts ...grpc.CallOption) (Trading212Service_GetUpdatedSymbolsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Trading212Service_ServiceDesc.Streams[0], "/protobuf.Trading212Service/GetUpdatedSymbols", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *trading212ServiceGetUpdatedSymbolsClient) Recv() (*Symbol, error) {
	m := new(Symbol)
...
func (c *trading212ServiceClient) GetSymbols(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (Trading212Service_GetSymbolsClient, error) {
	stream, err := c.cc.NewStream(ctx, &Trading212Service_ServiceDesc.Streams[1], "/protobuf.Trading212Service/GetSymbols", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *trading212ServiceGetSymbolsClient) Recv() (*Symbol, error) {
	m := new(Symbol)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
type Trading212ServiceServer interface {
	GetUpdatedSymbols(*Symbols, Trading212Service_GetUpdatedSymbolsServer) error
...
func (UnimplementedTrading212ServiceServer) GetUpdatedSymbols(*Symbols, Trading212Service_GetUpdatedSymbolsServer) error {
...
func (x *trading212ServiceGetUpdatedSymbolsServer) Send(m *Symbol) error {
...
func (x *trading212ServiceGetSymbolsServer) Send(m *Symbol) error {
	return x.ServerStream.SendMsg(m)
}
...
var Trading212Service_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "protobuf.Trading212Service",
